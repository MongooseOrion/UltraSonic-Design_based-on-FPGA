...
HD_PWD='C:/Users/smn90/Desktop/Ultrasonic/Vivado Project/UltraSonic_design/UltraSonic_design.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_Ranging.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_Ranging.tcl -notrace
