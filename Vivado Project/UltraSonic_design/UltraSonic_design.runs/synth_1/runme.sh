...
HD_PWD='C:/Users/smn90/Desktop/Ultrasonic/Vivado Project/UltraSonic_design/UltraSonic_design.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_Ranging.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_Ranging.tcl
