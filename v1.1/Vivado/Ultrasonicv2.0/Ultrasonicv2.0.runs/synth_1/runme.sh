...
HD_PWD='C:/Users/smn90/Desktop/Ultrasonic/v1.1/Vivado/Ultrasonicv2.0/Ultrasonicv2.0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_ultrasonic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_ultrasonic.tcl
